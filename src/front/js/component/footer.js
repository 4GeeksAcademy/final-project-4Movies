...
export const Footer = () => (
  <footer
    className="footer container-fluid mt-auto py-3 text-center bg-dark"
    style={{ position: "static", width: "100%", bottom: 0 }}
  >
    <div
      className="color-footer container text-center d-flex"
    ...
    >
      ...
      >
        ...
        <p style={{ textAlign: "left" }}>
          Una red social que conecta entretenimiento con personas
        </p>
      ...
      <div className="col-md-4 col-sm-4">
        ...
        <p style={{ textAlign: "left" }}>
          Recibe notificaciones con promociones exclusivas
        </p>
